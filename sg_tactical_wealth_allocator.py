...
def render_executive():
    ...
    top_target_warning_html = f'<div style="font-size:11px;color:#DC2626;font-weight:950;line-height:1.2;margin-top:3px;">⚠ {hesc(best["Market"])} over-deployed {target_overdeploy_tip}</div>' if best_market_overdeployed else ''
