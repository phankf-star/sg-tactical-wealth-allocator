...
try:
    _actual_total_for_rule,_actual_by_market_for_rule,_deployed_source_for_rule=_actual_deployed_base_amount(currency_code)
    _selected_market_actual_for_rule=max(float((_actual_by_market_for_rule or {}).get(sel,0.0)),0.0)
except Exception:
    _selected_market_actual_for_rule=0.0
