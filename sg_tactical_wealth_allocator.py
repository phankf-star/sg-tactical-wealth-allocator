...
st.markdown('''
<style>
.cde-nav-active{background:#fff;border-left:4px solid #16a34a;padding:8px 10px;margin:4px 0;font-weight:900;color:#111827}.cde-subpanel{background:#f8fafc;border-left:2px solid #e2e8f0;margin:0 0 8px 10px;padding:8px 0 10px 12px}.cde-logo-card{background:#fff;border:1px solid #d3dfec;border-radius:14px;padding:10px 10px;margin-bottom:14px;display:flex;align-items:center;gap:9px;box-shadow:0 1px 2px rgba(15,23,42,.06)}.cde-logo-mark{width:42px;height:42px;border-radius:50%;border:2px solid #d3dfec;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#fff,#f8fafc);flex:0 0 42px}.cde-logo-mark:before{content:'';width:20px;height:25px;background:linear-gradient(180deg,#f97316 0 36%,#22c55e 36% 100%);clip-path:polygon(0 100%,18% 58%,34% 74%,55% 34%,72% 54%,100% 0,100% 100%);display:block}.cde-logo-main{color:#0f172a;font-size:16px;font-weight:950;line-height:1.05;letter-spacing:.2px}.cde-logo-sub{color:#059669;font-size:10px;font-weight:950;line-height:1.05;margin-top:1px}.cde-logo-tag{color:#64748b;font-size:7.2px;font-weight:800;margin-top:5px;white-space:nowrap}.cde-hero{display:flex;justify-content:space-between;gap:18px;margin:0 0 20px}.cde-title{font-size:38px;font-weight:950;color:#0f172a}.cde-subtitle{font-size:16px;color:#475569;font-weight:800}.cde-page-label{font-size:22px;color:#334155;font-weight:900}.cde-refresh-box{text-align:right;font-size:12px;color:#64748b;font-weight:800}.cde-pill{display:inline-block;background:#eff6ff;border:1px solid #bfdbfe;color:#1d4ed8;border-radius:999px;padding:5px 10px;margin-top:4px}.cde-grid{display:grid;gap:16px;margin-bottom:22px}.cde-kpi-grid{grid-template-columns:1fr 1fr 1fr 1.45fr}.cde-three-grid{grid-template-columns:1fr 1fr 1fr}.cde-bottom-grid{grid-template-columns:1.2fr 1.05fr .95fr}.cde-card{background:#f9fbfd;border:1px solid #d3dfec;border-radius:14px;padding:17px 18px;min-height:118px}.cde-card-title{font-size:14px;color:#334155;font-weight:950;margin-bottom:10px}.cde-main-value{font-size:28px;font-weight:950;color:#0f172a}.cde-card-sub{font-size:12.5px;color:#64748b;font-weight:750}.cde-green{color:#059669}.cde-orange{color:#f97316}.cde-blue{color:#2563eb}.cde-flag-label{font-size:1em;white-space:nowrap}.cde-row-head{background:#e8eef5;border:1px solid #d3dfec;border-radius:10px 10px 0 0;padding:10px 12px;font-size:12px;font-weight:950;color:#334155}.cde-row-line{border-left:1px solid #e2e8f0;border-right:1px solid #e2e8f0;border-bottom:1px solid #e2e8f0;padding:7px 12px;font-size:12.5px;font-weight:800;min-height:34px;display:flex;align-items:center}.cde-command-card{background:#fff;border:1px solid #d3dfec;border-radius:14px;padding:10px 12px;margin:6px 0 14px}.cde-command-title{font-size:15px;font-weight:950;color:#0f172a;margin-bottom:1px}.cde-command-sub{font-size:10.5px;color:#64748b;font-weight:760;margin-bottom:8px}.cde-command-top{display:grid;grid-template-columns:1.15fr .9fr 1.1fr .95fr .75fr;gap:8px}.cde-command-mini{border-left:1px solid #e2e8f0;padding-left:8px;min-height:42px}.cde-command-mini:first-child{border-left:0;padding-left:0}.cde-command-label{font-size:8.8px;color:#475569;font-weight:950;text-transform:uppercase;letter-spacing:.02em}.cde-command-value{font-size:16px;font-weight:950;color:#0f172a;line-height:1.1;margin-top:2px}.cde-command-note{font-size:9px;color:#64748b;font-weight:760;margin-top:1px}.cde-command-mid{display:grid;grid-template-columns:1.08fr 1fr;gap:8px;margin-top:8px}.cde-command-panel{background:#f9fbfd;border:1px solid #e2e8f0;border-radius:10px;padding:8px}.cde-command-panel .cde-card-title{font-size:11px;margin-bottom:4px}.cde-command-panel .cde-ladder-row{display:inline-grid;grid-template-columns:1fr 32px 1fr;gap:4px;width:32%;font-size:9px;margin:2px 3px 2px 0}.cde-command-next{display:grid;grid-template-columns:.75fr 1.25fr;gap:8px;margin-top:8px;background:#ecfdf5;border:1px solid #bbf7d0;border-radius:10px;padding:8px}.cde-command-next .cde-command-value{font-size:17px}@media(max-width:900px){.cde-command-top,.cde-command-mid,.cde-command-next{grid-template-columns:1fr}.cde-command-mini{border-left:0;border-top:1px solid #e2e8f0;padding-left:0;padding-top:8px}.cde-command-mini:first-child{border-top:0;padding-top:0}.cde-command-panel .cde-ladder-row{width:100%}}.cde-env-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:9px}.cde-env-grid b{display:block;font-size:14px;font-weight:950}.cde-env-grid span{font-size:10.5px;color:#64748b;font-weight:800}.cde-section-title{font-size:21px;font-weight:950;color:#111827}.cde-section-sub{font-size:12.5px;color:#52657a;font-weight:760;margin-bottom:11px}.cde-table{width:100%;border-collapse:collapse;background:#fff;border:1px solid #d3dfec;border-radius:12px;overflow:hidden;margin-bottom:20px}.cde-table th{background:#e8eef5;color:#334155;text-align:left;padding:11px 13px;font-size:12px;font-weight:950}.cde-table td{padding:12px 13px;border-bottom:1px solid #e2e8f0;font-weight:800;font-size:12.5px}.cde-sig{border-radius:999px;padding:4px 9px;font-size:10.5px;font-weight:950}.cde-sig.buy{background:#dcfce7;color:#047857}.cde-sig.watch{background:#ffedd5;color:#c2410c}.cde-sig.hold{background:#e5e7eb;color:#374151}.cde-ladder-row{display:grid;grid-template-columns:1.1fr 58px 1fr;gap:8px;font-size:12.5px;margin:7px 0;font-weight:800}.cde-dot{width:10px;height:10px;border-radius:50%;display:inline-block;margin-right:7px;background:#cbd5e1}.cde-dot.active{background:#f97316}.cde-donut{width:86px;height:86px;border-radius:50%;background:conic-gradient(#4f7bd9 var(--deg),#e2e8f0 0);display:flex;align-items:center;justify-content:center;margin:auto}.cde-donut:before{content:attr(data-label);width:54px;height:54px;border-radius:50%;background:#fff;display:flex;align-items:center;justify-content:center;font-weight:950;color:#0f2e5d;font-size:12px}.cde-allocation{display:grid;grid-template-columns:105px 1fr;gap:14px;align-items:center}.cde-mini-metrics{display:flex;gap:22px;align-items:flex-end;flex-wrap:wrap}.cde-mini-metrics b{display:block;font-size:24px;color:#059669;font-weight:950}.cde-mini-metrics span{font-size:11.5px;color:#64748b;font-weight:850}.cde-takeaway{display:flex;gap:14px;align-items:center}.cde-icon{width:42px;height:42px;border-radius:50%;background:#dcfce7;color:#059669;display:flex;align-items:center;justify-content:center;font-size:21px;font-weight:950}@media(max-width:900px){.cde-hero{display:block}.cde-kpi-grid,.cde-three-grid,.cde-bottom-grid{grid-template-columns:1fr}.cde-title{font-size:30px}.cde-card{min-height:auto}.cde-env-grid{grid-template-columns:repeat(2,1fr)}}
</style>
...
with st.sidebar:
    ...
    if st.session_state.active_section == '▣ Market Deep Dive':
        ...
        if current_ag not in ag_options: current_ag='Market / Equity Index'; st.session_state.asset_group_selection=current_ag
        ...
        if current_sel not in group_items: current_sel=default_item; st.session_state.selected_market_name=current_sel
...
def render_executive():
    ...
    # LP-R1-02 display-only flags. Internal keys/tickers/calculations remain unchanged.
    flag_map={'HSI':'🇭🇰','KLSE':'🇲🇾','STI':'🇸🇬','A-Share':'🇨🇳','Nasdaq':'🇺🇸','S&P 500':'🇺🇸','DJIA':'🇺🇸','Nikkei 225':'🇯🇵'}
    def market_label(market_name):
        return f"{flag_map.get(market_name,'')} {market_name}".strip()
    def market_label_html(market_name):
        return f'<span class="cde-flag-label">{hesc(market_label(market_name))}</span>'
    ...
    score_tip=tooltip_html('Market Opportunity Score',[('Definition','Market Opportunity Score is a landing-level 0–100 ranking score based on drawdown depth and active deployment tier. It is used for cross-market prioritisation only.')],'Not a return forecast and not a detailed Market Deep Dive score.')
    ...
    table_rows=''.join([f'''<tr><td>{i}</td><td>{market_label_html(r['Market'])}</td><td>{hesc(r['Index / ETF'])}</td><td class="cde-orange">{r['Drawdown']:.1f}%</td><td>{r['Score']}</td><td><span class="cde-sig {'buy' if r['Signal']=='BUY' else 'watch' if r['Signal']=='WATCH' else 'hold'}">{hesc(r['Signal'])}</span></td></tr>''' for i,r in enumerate(rows,1)])
    ...
    ladder_html=f'''<div class="cde-ladder-row"><span><span class="cde-dot {'active' if best_deploy_pct==0 else ''}"></span>0% to -8%</span><b>0%</b><span>Hold</span></div><div class="cde-ladder-row"><span><span class="cde-dot {'active' if best_deploy_pct==.10 else ''}"></span>-8% to -15%</span><b class="cde-orange">10%</b><span>Initial deploy</span></div><div class="cde-ladder-row"><span><span class="cde-dot {'active' if best_deploy_pct==.25 else ''}"></span>-15% to -25%</span><b class="cde-green">25%</b><span>Deploy more</span></div><div class="cde-ladder-row"><span><span class="cde-dot {'active' if best_deploy_pct==.50 else ''}"></span>-25% to -35%</span><b class="cde-green">50%</b><span>Strong deploy</span></div><div class="cde-ladder-row"><span><span class="cde-dot {'active' if best_deploy_pct==.75 else ''}"></span>-35% to -50%</span><b class="cde-orange">75%</b><span>Crisis deploy</span></div><div class="cde-ladder-row"><span><span class="cde-dot {'active' if best_deploy_pct==1 else ''}"></span>-50%+</span><b class="cde-orange">100%</b><span>Maximum deploy</span></div>'''
    ...
    header_cols=st.columns([0.45,1.45,1.15,.9,.7,.85,.85])
    for _col,_label in zip(header_cols,['Rank','Market','Index / ETF','Drawdown','Score ⓘ','Signal','Deep Dive']):
        _col.markdown(f'<div class="cde-row-head">{_label}</div>', unsafe_allow_html=True)
    for i,r in enumerate(rows,1):
        row_cols=st.columns([0.45,1.45,1.15,.9,.7,.85,.85])
    ...
    st.markdown(f'''<div class="cde-command-card"><div class="cde-command-title">Deployment Command Centre</div><div class="cde-command-sub">Compact next deployment trigger panel. Figures are system-calculated.</div><div class="cde-command-top"><div class="cde-command-mini"><div class="cde-command-label">Target Market</div><div class="cde-command-value">{market_label_html(best['Market'])}</div><div class="cde-command-note">Highest priority market</div></div><div class="cde-command-mini"><div class="cde-command-label">Trigger Level</div><div class="cde-command-value">{hesc(next_trigger)}</div><div class="cde-command-note">Drawdown trigger</div></div><div class="cde-command-mini"><div class="cde-command-label">Current Drawdown</div><div class="cde-command-value">{best['Drawdown']:.1f}%</div><div class="cde-command-note">Active tier: {hesc(active_tier)}</div></div><div class="cde-command-mini"><div class="cde-command-label">Distance to Trigger</div><div class="cde-command-value">{hesc(distance)}</div><div class="cde-command-note">Next future trigger only</div></div><div class="cde-command-mini"><div class="cde-command-label">Confidence</div><div class="cde-command-value">{hesc(confidence_label)}</div><div class="cde-command-note">System score basis</div></div></div><div class="cde-command-mid"><div class="cde-command-panel"><div class="cde-card-title">Deployment Ladder</div>{ladder_html}</div><div class="cde-command-panel"><div class="cde-card-title">Deployment Allocation</div><div class="cde-allocation"><div class="cde-donut" style="--deg:{donut_deg}deg" data-label="{best_deploy_pct:.0%}"></div><div class="cde-card-sub">● Cash available&nbsp;&nbsp; {fmt_sgd_html(remaining_amt)}<br>● Deployed&nbsp;&nbsp; {fmt_sgd_html(deployed_amt)}<br>● Other funds&nbsp;&nbsp; {fmt_sgd_html(0)}</div></div></div></div><div class="cde-command-next"><div><div class="cde-command-label">Next Deployment Amount</div><div class="cde-command-value">{fmt_sgd_html(next_deploy_amt)}</div><div class="cde-command-note">{next_increment:.0%} incremental</div></div><div><div class="cde-command-label">Condition</div><div class="cde-card-sub">{hesc(condition_text)}</div></div></div></div><section class="cde-grid cde-bottom-grid"><div class="cde-card cde-takeaway"><div class="cde-icon">⊙</div><div><div class="cde-card-title">Key Takeaway</div><div class="cde-card-sub">Opportunities are ranked across all supported equity markets. Single-market execution and all original details remain inside Market Deep Dive.</div></div></div><div class="cde-card"><div class="cde-card-title">Historical Edge — All Markets {edge_tip}</div>{edge_html}</div><div class="cde-card cde-takeaway"><div class="cde-icon">✓</div><div><div class="cde-card-title">System Status</div><div class="cde-card-sub">All systems operational<br>Data quality: High<br>Model confidence: Good</div></div></div></section>''', unsafe_allow_html=True)
