...
def render_executive():
    ...
    # Top layer: Best Opportunity first as corrected by user.
    ...
    # Command Centre: compact and no green Next Deployment background; order = Next Amount, Allocation, Condition.
