...
.cde-kpi-grid .cde-card{height:154px;min-height:154px;box-sizing:border-box;display:flex;flex-direction:column;justify-content:space-between;overflow:hidden}.cde-kpi-grid .cde-card-title{min-height:26px}.cde-kpi-grid .cde-main-value{line-height:1.05}.cde-nav-group-caption{font-size:11px;color:#64748b;font-weight:750;margin:2px 0 8px}.cde-dcc-title{font-size:19px;font-weight:950;color:#0f172a;margin:8px 0 2px}.cde-dcc-sub{font-size:12px;color:#475569;font-weight:800;margin-bottom:10px}.cde-dcc-box{background:#fff;border:1px solid #d3dfec;border-radius:14px;padding:12px;min-height:292px}.cde-dcc-section-title{font-size:14px;font-weight:950;color:#0f172a;margin:0 0 8px}.cde-dcc-mini{background:#f8fafc;border:1px solid #e2e8f0;border-radius:11px;padding:9px;min-height:78px}.cde-dcc-mini-target{background:#ecfdf5;border-color:#bbf7d0}.cde-dcc-mini span{display:block;font-size:10px;color:#64748b;font-weight:950;letter-spacing:.02em}.cde-dcc-mini b{display:block;font-size:17px;color:#0f172a;margin-top:5px}.cde-dcc-split{border-top:1px solid #e2e8f0;margin:12px 0 10px}.cde-dcc-line{font-size:12.5px;color:#334155;font-weight:800;margin:5px 0}.cde-dcc-line b{color:#0f172a}.cde-dcc-main-amount{font-size:24px;font-weight:950;color:#0f172a;margin-bottom:8px}.cde-market-exposure{margin-top:6px;font-size:12px;color:#334155;font-weight:800}.cde-market-exposure-row{display:flex;justify-content:space-between;gap:8px;border-bottom:1px solid #eef2f7;padding:4px 0}.cde-capital-summary-row{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:7px 0}.cde-capital-summary-row div{background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:8px}.cde-capital-summary-row b{display:block;font-size:16px;color:#059669}.cde-capital-summary-row span{font-size:10.5px;color:#64748b;font-weight:850}
...
def render_executive():
    ...
    with dcc_col:
        with st.container(border=True):
            ...
            with cap_col:
                st.markdown(f'''<div class="cde-dcc-section-title">Capital Exposure</div><div class="cde-capital-summary-row"><div><b>{fmt_sgd_html(total_cap)}</b><span>Total Capital</span></div><div><b>{fmt_sgd_html(deployed_amt)}</b><span>Allocated</span></div></div><div class="cde-dcc-line"><b>Current Allocated / Deployed by Market</b></div><div class="cde-market-exposure">{market_exposure_html}</div>''', unsafe_allow_html=True)
