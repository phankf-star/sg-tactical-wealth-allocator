...
/* LP-R1 mockup image 2: unified parent card with 29/71 split and internal subcards */
.cde-dcc-parent [data-testid="stVerticalBlockBorderWrapper"]{border:1px solid #bfdbfe!important;border-radius:18px!important;background:#fff!important;padding:12px 14px!important;box-sizing:border-box!important}.cde-dcc-parent div[data-testid="column"]{align-self:stretch!important}.cde-dcc-panel-card{height:250px!important;min-height:250px!important;max-height:250px!important;box-sizing:border-box!important;border:1px solid #d3dfec!important;border-radius:14px!important;background:#fff!important;padding:14px!important;overflow:hidden!important}.cde-dcc-panel-card .cde-watch-title{font-size:15.5px!important;font-weight:950!important;line-height:1.2!important}.cde-dcc-panel-card .cde-watch-sub{font-size:11px!important;color:#64748b!important;font-weight:800!important;margin-top:4px!important}.cde-dcc-panel-card .cde-watch-item{padding:10px 0!important}.cde-dcc-panel-card .cde-watch-item b{font-size:12.6px!important}.cde-dcc-panel-card .cde-watch-item span{font-size:12.4px!important}.cde-dcc-panel-card .cde-watch-item em{font-size:12.4px!important;font-style:normal!important;font-weight:950!important}.cde-dcc-right-grid{height:250px!important;min-height:250px!important;max-height:250px!important;display:grid!important;grid-template-rows:104px 134px!important;gap:12px!important;box-sizing:border-box!important}.cde-dcc-action-card,.cde-dcc-support-card{border:1px solid #d3dfec!important;border-radius:14px!important;background:#fff!important;padding:12px!important;box-sizing:border-box!important;overflow:hidden!important}.cde-dcc-action-card{height:104px!important}.cde-dcc-bottom-grid{display:grid!important;grid-template-columns:0.28fr 0.32fr 0.40fr!important;gap:12px!important;height:134px!important}.cde-dcc-support-card{height:134px!important}.cde-dcc-section-title{font-size:13px!important;font-weight:900!important;color:#0f172a!important;margin:0 0 8px!important}.cde-dcc-action-row{display:grid!important;grid-template-columns:1.15fr 1fr 1fr 1fr 1fr!important;gap:10px!important}.cde-dcc-mini{min-height:58px!important;padding:9px 10px!important;border-radius:10px!important;background:#f8fafc!important;border:1px solid #e2e8f0!important;display:flex!important;flex-direction:column!important;justify-content:center!important}.cde-dcc-mini-target{background:#ecfdf5!important;border-color:#bbf7d0!important}.cde-dcc-mini span{font-size:9.5px!important;color:#64748b!important;font-weight:850!important;line-height:1.1!important;margin-bottom:6px!important}.cde-dcc-mini b{font-size:13.5px!important;color:#0f172a!important;line-height:1.1!important;white-space:nowrap!important}.cde-dcc-mini-target b{font-size:14px!important;color:#047857!important;display:flex!important;gap:5px!important;align-items:center!important}.cde-dcc-mini-target .cde-flag-circle{width:16px!important;height:16px!important;min-width:16px!important;font-size:9px!important;margin:0!important}.cde-dcc-main-amount{font-size:18px!important;font-weight:950!important;color:#0f172a!important;margin:5px 0 8px!important}.cde-dcc-line{font-size:10.5px!important;color:#334155!important;font-weight:800!important;margin:3px 0!important;line-height:1.22!important}.cde-capital-summary-row{display:grid!important;grid-template-columns:1fr!important;gap:3px!important;margin:2px 0 4px!important}.cde-capital-summary-row div{display:grid!important;grid-template-columns:1fr auto auto!important;align-items:center!important;gap:8px!important;border:0!important;border-radius:6px!important;background:#fff!important;padding:1px 0!important}.cde-capital-summary-row span{font-size:10.5px!important;color:#64748b!important;font-weight:800!important}.cde-capital-summary-row b{font-size:11.5px!important;color:#059669!important;font-weight:900!important}.cde-capital-summary-row em{font-style:normal!important;font-size:10.5px!important;color:#dc2626!important;font-weight:900!important}.cde-market-exposure{font-size:10.5px!important;margin-top:2px!important}.cde-market-exposure-row{padding:3px 0!important;border-bottom:1px solid #eef2f7!important}.cde-market-preview-caption{font-size:10.2px!important;color:#64748b!important;font-weight:800!important;margin:-3px 0 3px!important}.cde-dcc-parent div[data-testid="stButton"]{margin-top:4px!important}.cde-dcc-parent div[data-testid="stButton"] button{border-radius:999px!important;border-color:#d3dfec!important;font-size:10.5px!important;font-weight:850!important;color:#2563eb!important;background:#fff!important;padding:4px 9px!important}.cde-dcc-title{font-size:18px!important}.cde-dcc-sub{font-size:11.5px!important;color:#475569!important;margin-bottom:8px!important}


/* LP-R1 retained top KPI polish: funding status and macro gauge same row */
...
/* LP-R1 visual fix: DCC left and right content start at same top level */
.cde-dcc-parent [data-testid="stVerticalBlockBorderWrapper"]{border:1px solid #bfdbfe!important;border-radius:18px!important;background:#fff!important;padding:12px 14px!important;box-sizing:border-box!important}.cde-dcc-parent div[data-testid="column"]{align-self:stretch!important}.cde-dcc-panel-card{height:250px!important;min-height:250px!important;max-height:250px!important;box-sizing:border-box!important;border:1px solid #d3dfec!important;border-radius:14px!important;background:#fff!important;padding:14px!important;overflow:hidden!important}.cde-dcc-panel-card .cde-watch-title{font-size:15.5px!important;font-weight:950!important;line-height:1.2!important}.cde-dcc-panel-card .cde-watch-sub{font-size:11px!important;color:#64748b!important;font-weight:800!important;margin-top:4px!important}.cde-dcc-panel-card .cde-watch-item{padding:10px 0!important}.cde-dcc-panel-card .cde-watch-item b{font-size:12.6px!important}.cde-dcc-panel-card .cde-watch-item span{font-size:12.4px!important}.cde-dcc-panel-card .cde-watch-item em{font-size:12.4px!important;font-style:normal!important;font-weight:950!important}.cde-dcc-right-flat{height:250px!important;min-height:250px!important;max-height:250px!important;box-sizing:border-box!important;overflow:hidden!important}.cde-dcc-action-card{height:104px!important;border:1px solid #d3dfec!important;border-radius:14px!important;background:#fff!important;padding:12px!important;box-sizing:border-box!important;overflow:hidden!important;margin:0 0 12px 0!important}.cde-dcc-support-card{height:134px!important;border:1px solid #d3dfec!important;border-radius:14px!important;background:#fff!important;padding:12px!important;box-sizing:border-box!important;overflow:hidden!important}.cde-dcc-section-title{font-size:13px!important;font-weight:900!important;color:#0f172a!important;margin:0 0 8px!important}.cde-dcc-action-row{display:grid!important;grid-template-columns:1.15fr 1fr 1fr 1fr 1fr!important;gap:10px!important}.cde-dcc-mini{min-height:58px!important;padding:9px 10px!important;border-radius:10px!important;background:#f8fafc!important;border:1px solid #e2e8f0!important;display:flex!important;flex-direction:column!important;justify-content:center!important}.cde-dcc-mini-target{background:#ecfdf5!important;border-color:#bbf7d0!important}.cde-dcc-mini span{font-size:9.5px!important;color:#64748b!important;font-weight:850!important;line-height:1.1!important;margin-bottom:6px!important}.cde-dcc-mini b{font-size:13.5px!important;color:#0f172a!important;line-height:1.1!important;white-space:nowrap!important}.cde-dcc-mini-target b{font-size:14px!important;color:#047857!important;display:flex!important;gap:5px!important;align-items:center!important}.cde-dcc-mini-target .cde-flag-circle{width:16px!important;height:16px!important;min-width:16px!important;font-size:9px!important;margin:0!important}.cde-dcc-main-amount{font-size:18px!important;font-weight:950!important;color:#0f172a!important;margin:5px 0 8px!important}.cde-dcc-line{font-size:10.5px!important;color:#334155!important;font-weight:800!important;margin:3px 0!important;line-height:1.22!important}.cde-capital-summary-row{display:grid!important;grid-template-columns:1fr!important;gap:3px!important;margin:2px 0 4px!important}.cde-capital-summary-row div{display:grid!important;grid-template-columns:1fr auto auto!important;align-items:center!important;gap:8px!important;border:0!important;border-radius:6px!important;background:#fff!important;padding:1px 0!important}.cde-capital-summary-row span{font-size:10.5px!important;color:#64748b!important;font-weight:800!important}.cde-capital-summary-row b{font-size:11.5px!important;color:#059669!important;font-weight:900!important}.cde-capital-summary-row em{font-style:normal!important;font-size:10.5px!important;color:#dc2626!important;font-weight:900!important}.cde-market-exposure{font-size:10.5px!important;margin-top:2px!important}.cde-market-exposure-row{padding:3px 0!important;border-bottom:1px solid #eef2f7!important}.cde-dcc-parent div[data-testid="stButton"]{margin-top:4px!important}.cde-dcc-parent div[data-testid="stButton"] button{border-radius:999px!important;border-color:#d3dfec!important;font-size:10.5px!important;font-weight:850!important;color:#2563eb!important;background:#fff!important;padding:4px 9px!important}.cde-dcc-title{font-size:18px!important}.cde-dcc-sub{font-size:11.5px!important;color:#475569!important;margin-bottom:8px!important}
...
def render_executive():
    ...
    # Deployment & Capital Command Centre — image 2 mockup layout, same top level.
    watch_items=[]
    for r in rows:
    ...
    market_preview_tip=tooltip_html('Market Exposure Preview',[('Scope','Shows only the largest deployed market exposures.'),('Full detail','Open Portfolio & Trade Log for full market-by-market allocation.')],'Keeps the landing page compact while preserving access to full portfolio details.')
    ...
    with st.container(border=True):
        ...
        with watch_col:
            st.markdown(f'''<div class="cde-dcc-panel-card"><div class="cde-watch-title">Next Trigger Watchlist</div><div class="cde-watch-sub">Top nearby trigger levels</div>{watch_html}</div>''', unsafe_allow_html=True)
        with dcc_col:
            st.markdown('<div class="cde-dcc-right-flat">', unsafe_allow_html=True)
            st.markdown(f'''<div class="cde-dcc-action-card"><div class="cde-dcc-section-title">Action Target</div><div class="cde-dcc-action-row"><div class="cde-dcc-mini cde-dcc-mini-target"><span>Target Market</span><b>{market_label_html(best['Market'])}</b></div><div class="cde-dcc-mini"><span>Trigger Level</span><b>{hesc(next_trigger)}</b></div><div class="cde-dcc-mini"><span>Current Drawdown</span><b>{best['Drawdown']:.1f}%</b></div><div class="cde-dcc-mini"><span>Distance</span><b>{hesc(distance)}</b></div><div class="cde-dcc-mini"><span>Confidence</span><b>{hesc(confidence_label)}</b></div></div></div>''', unsafe_allow_html=True)
            b1,b2,b3=st.columns([0.28,0.32,0.40], gap='small')
            with b1:
                st.markdown(f'''<div class="cde-dcc-support-card"><div class="cde-dcc-section-title">Next Deployment</div><div class="cde-dcc-main-amount">{fmt_sgd_html(next_deploy_amt)}</div><div class="cde-dcc-line"><b>Condition:</b> {hesc(condition_text)}</div><div class="cde-dcc-line"><b>Available Dry Powder:</b> {fmt_sgd_html(remaining_amt)}</div><div class="cde-dcc-line"><b>Coverage:</b> {hesc(coverage_text)}</div></div>''', unsafe_allow_html=True)
            with b2:
                st.markdown(f'''<div class="cde-dcc-support-card"><div class="cde-dcc-section-title">Capital Exposure</div><div class="cde-capital-summary-row"><div><span>Total Capital</span><b>{fmt_sgd_html(total_cap)}</b><em>100%</em></div><div><span>Allocated</span><b>{fmt_sgd_html(deployed_amt)}</b><em>{alloc_pct:.0%}</em></div><div><span>Dry Powder</span><b>{fmt_sgd_html(remaining_amt)}</b><em>{dry_pct:.0%}</em></div></div></div>''', unsafe_allow_html=True)
            with b3:
                st.markdown(f'''<div class="cde-dcc-support-card"><div class="cde-dcc-section-title">Market Exposure Preview {market_preview_tip}</div><div class="cde-market-exposure">{market_exposure_html}</div></div>''', unsafe_allow_html=True)
